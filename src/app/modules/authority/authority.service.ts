...
import {MenuGroupApiResponse} from "../menu-group/types/MenuGroupApiResponse";
...
export class AuthorityService {
  ...
  findAll(params: any): Observable<any> {
    const requestUrl = `${this.baseUrl}/authorities?page=${params.pageNo}&size=${params.pageSize}&sort=${params.sortBy}`;
    return this.http.get<MenuGroupApiResponse>(requestUrl);
  }
